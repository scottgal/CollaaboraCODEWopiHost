...
public interface IWopiSecurityHandler
{
	...
	/// <summary>
	///     Retrieves a principal object using the given token. The principal can be extracted directly from the token or
	///     retrieved from an external storage based on the user identifier contained within the token.
	/// </summary>
