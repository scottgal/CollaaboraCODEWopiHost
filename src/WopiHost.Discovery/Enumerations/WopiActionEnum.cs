...
public enum WopiActionEnum
{
	...
	///     file for editing in Office for the web.
	///     Requires update, locks
	/// </summary>
	EditNew,

	/// <summary>
	///     An action that converts a document in a binary format, such as doc, into a modern format, like docx, so that it can
	///     be edited in Office for the web.
	///     Requires update, locks
	/// </summary>
	Convert,
	...
	///     collect form data via the formsubmit action.
	/// </summary>
	FormEdit,
