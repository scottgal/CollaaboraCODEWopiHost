...
public class WopiSecurityHandler : IWopiSecurityHandler
{
    ...
    {
        {
            ...
            new ClaimsPrincipal(
                new ClaimsIdentity(new List<Claim>
                {
                    ...
                    new(WopiClaimTypes.USER_PERMISSIONS,
                        (WopiUserPermissions.UserCanWrite | WopiUserPermissions.UserCanRename |
                         WopiUserPermissions.UserCanAttend | WopiUserPermissions.UserCanPresent).ToString())
                })
            )
        }
    };
    ...
    ///     An instance of a type used to configure the logging system and create instances of
        ...
        get
        {
            if (_key is null)
            {
                ...
                var key = Encoding.ASCII.GetBytes(
                    "secretKeysecretKeysecretKey123" /* + new Random(DateTime.Now.Millisecond).Next(1,999)*/);
    ...
    public SecurityToken GenerateAccessToken(string userId, string resourceId)
    {
        ...
        var tokenDescriptor = new SecurityTokenDescriptor
        {
            ...
            Expires = DateTime.UtcNow
                .AddHours(1), //access token ttl: https://learn.microsoft.com/en-us/microsoft-365/cloud-storage-partner-program/rest/concepts#the-access_token_ttl-property
