...
public class WopiFile : IWopiFile
{
    ...
    public string Extension
    {
        get
        {
            ...
            if (ext.StartsWith(".", StringComparison.InvariantCulture)) ext = ext[1..];
            return ext;
        }
    }
    ...
    public string Version =>
        FileVersionInfo.FileVersion ?? FileInfo.LastWriteTimeUtc.ToString(CultureInfo.InvariantCulture);
    ...
    public string Owner
    {
        get
        {
            ...
            if (OperatingSystem.IsLinux())
                return UnixFileSystemInfo.GetFileSystemEntry(FilePath).OwnerUser.UserName; //TODO: test
